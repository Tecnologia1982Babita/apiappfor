...
exports.createProduct  = async (requisao, res) => {
    ...
    const rows = await db.query('INSERT INTO entradas(documento, data, hora, codigovend, totaldesc, totalitens, totalgeral,operador, cancelado, alteracoes, bloqueado, tipo, origem)\r\
    \r\

...
exports.listAllProducts  = async (req, res) => {
 ...
 console.log(novaDataini, novaDatafim, codigofab)
    ...
    ELSE (coalesce(venda.quantidade_peca,0)+coalesce(estoque.qtd_estoque,0)) END  )*100.00),0.00)::numeric(5,2) as giro,coalesce(venda.preco_bruto,0.00) as preco_bruto, coalesce(venda.desconto,0.00) as desconto from\r\
    ...
    group by cod_fabricante, for_nom order by cod_fabricante)venda full join\r\

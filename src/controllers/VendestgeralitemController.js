...
exports.listAllProducts  = async (req,res) => {
 ...
 var novaDatafim = "'"+datafim.toString()+"'";
    ...
    coalesce(venda.preco_cheio1 , estoque.venda_total/(case when qtd_estoque = 0 then 1 else qtd_estoque end))::numeric(7,2) as preco_cheio1 from \r\
    \r\
    ...
    (CASE WHEN preco_cheio < 0 THEN preco_cheio*-1 ELSE preco_cheio END) as preco_cheio1\r\
    ...
    where codigo::integer = '+codigofab+' \r\
    group by codigo, nome_fornecedor, produtos_descricao, revista, erp_produtos.produtos_pagina, num_produto, \r\
    produtos_reffor, desc_basica order by num_produto)estoque \r\
    \r\
    on cod_fabricante = codigo::integer and venda.num_produto = estoque.num_produto')

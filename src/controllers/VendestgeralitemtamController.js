...
exports.listAllProducts  = async (req,res) => {
 ...
 var novaDatafim = "'"+datafim.toString()+"'";
    ...
    coalesce(estoque.nome_fornecedor,venda.for_nom) as nome_fornecedor, coalesce(estoque.qtd_estoque,0) as qtd_estoque, coalesce(estoque.venda_total,0.00) as venda_total_estoque,\r\
     ...
     (CASE WHEN preco_cheio < 0 THEN preco_cheio*-1 ELSE preco_cheio END) as preco_cheio1, produto, produtos_tamanho, tam_nom, produtos_cor, procor_descricao_cor\r\
     ...
     produtos_reffor, preco_cheio1,descricao_basica, produto, produtos_tamanho, tam_nom, produtos_cor, procor_descricao_cor order by num_produto)venda \r\
     \r\
     full join\r\
     \r\
     ...
     item, produtos_tamanho, tam_nom, produtos_cor, procor_descricao_cor\r\
     FROM view_estoque \r\
     ...
     produtos_reffor, item, produtos_tamanho, tam_nom, produtos_cor, procor_descricao_cor, desc_basica order by num_produto)estoque \r\
     \r\
